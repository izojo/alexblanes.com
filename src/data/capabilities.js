// ──────────────────────────────────────────────
// Core Capabilities — four cards.
// Order here = display order (left → right).
// Narrative arc: vision → commercial → scale → systems
// ──────────────────────────────────────────────

export const sectionLabel = "Expertise";
export const sectionTitle = "Core Capabilities";
